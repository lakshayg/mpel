...
namespace mplib {
	...
	void Workspace::draw(const Point& pt, int radius, const Scalar& color, int thickness) {
	    circle(disp, pt, radius, color, thickness);
	    update_display();
	}

	void Workspace::draw(const vector<Point>& path, const Scalar& color, int thickness) {
