#ifndef MPL_PLANNER_VORONOI_BOOST_H
#define MPL_PLANNER_VORONOI_BOOST_H
...
struct Segment {
	cv::Point p0;
	cv::Point p1;
	Segment(const cv::Point& a, const cv::Point& b) : p0(a), p1(b) {}
};

// map opencv point type to boost polygon point_concept
namespace boost {
namespace polygon {
...
// void sample_curved_edge(voronoi_edge edge, std::vector<voronoi_vertex>* sampled_edge);
